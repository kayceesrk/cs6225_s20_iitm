...
(* In this problem set, we'll get some practice using some of the polymorphic
 * container types, in particular, [option], [list], and [tree]. We'll then use
 * [tree] and [option] together to create binary tries (i.e., finite maps keyed
 * by lists of Booleans).
 *
